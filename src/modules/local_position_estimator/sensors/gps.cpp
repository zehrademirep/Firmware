...
void BlockLocalPositionEstimator::gpsCorrect()
{
	...
	// publish innovations
	_pub_innov.get().gps_hvel[0] = r(0);
	_pub_innov.get().gps_hvel[1] = r(1);
	_pub_innov.get().gps_vvel    = r(2);
	_pub_innov.get().gps_hpos[0] = r(3);
	_pub_innov.get().gps_hpos[1] = r(4);
	_pub_innov.get().gps_vpos    = r(5);

	// publish innovation variances
	_pub_innov_var.get().gps_hvel[0] = r(0);
	_pub_innov_var.get().gps_hvel[1] = r(1);
	_pub_innov_var.get().gps_vvel    = r(2);
	_pub_innov_var.get().gps_hpos[0] = r(3);
	_pub_innov_var.get().gps_hpos[1] = r(4);
	_pub_innov_var.get().gps_vpos    = r(5);
